...
HINSTANCE hInst;                      
WCHAR szTitle[MAX_LOADSTRING] = L"Lab 9";
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   bmp[0] = LoadImage(NULL, L"Image1.bmp", IMAGE_BITMAP, 60, 60, LR_LOADFROMFILE);
   bmp[1] = LoadImage(NULL, L"Image2.bmp", IMAGE_BITMAP, 60, 60, LR_LOADFROMFILE);
   bmp[2] = LoadImage(NULL, L"Image3.bmp", IMAGE_BITMAP, 60, 60, LR_LOADFROMFILE);
   bmp[3] = LoadImage(NULL, L"Image4.bmp", IMAGE_BITMAP, 60, 60, LR_LOADFROMFILE);
